...
const copies: Partial<Record<Language, ParticipationCopy>> = {
  ...
  it: { ...english, tag: 'Partecipa', title: 'Sostieni la richiesta di verità.', intro: 'Firma la petizione, ricevi aggiornamenti verificati o invia informazioni in privato.', petition: 'Firma la petizione', petitionBody: 'Sostieni la richiesta di piena trasparenza, rispetto del giusto processo e responsabilità. Il primo obiettivo è di 10.000 firme.', signatures: 'firme', goal: 'Primo obiettivo', name: 'Nome completo', email: 'Indirizzo e-mail', country: 'Paese', sign: 'Aggiungi la mia firma', petitionPrivacy: 'Il tuo nome e la tua e-mail non saranno mostrati pubblicamente. L’e-mail viene trasformata in un’impronta irreversibile per evitare firme duplicate.', newsletter: 'Ricevi aggiornamenti sul caso', newsletterBody: 'Iscriviti per ricevere gli aggiornamenti più importanti sul tribunale e sulla mobilitazione. Ti invieremo un messaggio di benvenuto dopo l’iscrizione.', consent: 'Accetto di ricevere aggiornamenti via e-mail e posso annullare l’iscrizione.', subscribe: 'Iscriviti', contact: 'Invia un messaggio privato', contactBody: 'Invia una correzione, una fonte o un messaggio senza indicare nome o e-mail.', message: 'Il tuo messaggio', send: 'Invia messaggio', anonymity: 'Non viene richiesta alcuna identità. I fornitori tecnici possono comunque trattare dati come l’indirizzo IP per prevenire abusi.', unavailable: 'Gli invii sono in preparazione e non sono ancora disponibili.', required: 'Completa la verifica prima dell’invio.', error: 'Non è stato possibile completare l’invio. Riprova.', success: { petition: 'La tua firma è stata registrata. Grazie.', newsletter: 'Grazie per l’iscrizione. Controlla la posta in arrivo e la cartella spam per il messaggio di benvenuto.', contact: 'Il tuo messaggio è stato ricevuto.' } },
  zgh: { ...english, tag: 'ⵜⵜⴽⴽⵉ', title: 'ⴷⴷⵓ ⴷ ⵓⵜⵜⵔ ⵏ ⵜⵉⴷⵜ.', intro: 'ⵣⵎⵎⴻⵎ ⴳ ⵜⵓⵜⵜⵔⴰ، ⴰⵡⵉ ⵉⵎⴰⵢⵏⵓⵜⵏ ⵉⵜⵜⵓⵙⵙⵏⴷⵏ، ⵏⵖ ⴰⵣⵏ ⵉⵙⴰⵍⵏ ⵙ ⵓⵙⵍⵉⴳ.', petition: 'ⵣⵎⵎⴻⵎ ⴳ ⵜⵓⵜⵜⵔⴰ', petitionBody: 'ⴷⴷⵓ ⴷ ⵓⵜⵜⵔ ⵏ ⵓⴱⵢⵢⵏ ⵓⵎⵎⵉⴷ، ⵓⵙⵙⵔⵓ ⵏ ⵓⵙⴰⴷⴼ ⴷ ⵓⵎⵙⴰⵙⴰ. ⵉⵙⵡⵉ ⴰⵎⵣⵡⴰⵔⵓ ⴷ 10,000 ⵉⵣⵎⴰⵎⵏ.', signatures: 'ⵉⵣⵎⴰⵎⵏ', goal: 'ⵉⵙⵡⵉ ⴰⵎⵣⵡⴰⵔⵓ', name: 'ⵉⵙⵎ ⵓⵎⵎⵉⴷ', email: 'ⵉⵎⴰⵢⵍ', country: 'ⵜⴰⵎⴰⵣⵉⵔⵜ', sign: 'ⵔⵏⵓ ⴰⵣⵎⵎⴻⵎ ⵉⵏⵓ', petitionPrivacy: 'ⵓⵔ ⵔⴰⴷ ⵉⵜⵜⵓⵙⴽⴰⵏ ⵉⵙⵎ ⵏⵏⴽ ⵏⵖ ⵉⵎⴰⵢⵍ ⵏⵏⴽ. ⵉⵎⴰⵢⵍ ⴰⴷ ⵉⵜⵜⵓⵙⵎⵔⵙ ⵙ ⵢⴰⵜ ⵜⵎⴰⵜⴰⵔⵜ ⵓⵔ ⵉⵜⵜⵓⵔⴰⵔⵏ ⴰⴼⴰⴷ ⴰⴷ ⵓⵔ ⵜⵜⵓⵙⵏⴼⵍⵏ ⵉⵣⵎⴰⵎⵏ.', newsletter: 'ⴰⵡⵉ ⵉⵎⴰⵢⵏⵓⵜⵏ ⵏ ⵜⵎⵙⴰⵍⵜ', newsletterBody: 'ⵍⴽⵎ ⴰⴼⴰⴷ ⴰⴷ ⴽ ⵉⴷ ⴰⵡⴹⵏ ⵉⵎⴰⵢⵏⵓⵜⵏ ⵉⵎⵇⵇⵔⴰⵏⵏ ⵏ ⵜⵎⵙⴰⵍⵜ ⴷ ⵓⵏⴱⴰⴹ. ⵔⴰⴷ ⴰⴽ ⵏⴰⵣⵏ ⵉⵣⵏ ⵏ ⵓⵏⵙⵙⵓⴼ ⵎⴽ ⵜⵍⴽⵎⴷ.', consent: 'ⵇⴱⵍⵖ ⴰⴷ ⵉⵢⵉ ⴷ ⴰⵡⴹⵏ ⵉⵎⴰⵢⵏⵓⵜⵏ ⵙ ⵉⵎⴰⵢⵍ، ⵣⵎⵔⵖ ⴰⴷ ⴼⴼⵖⵖ ⵙⴳ ⵓⵍⴽⴰⵎ.', subscribe: 'ⵍⴽⵎ', contact: 'ⴰⵣⵏ ⵉⵣⵏ ⵓⵙⵍⵉⴳ', contactBody: 'ⴰⵣⵏ ⴰⵙⵏⴼⵍ، ⴰⵙⴰⴳⵎ ⵏⵖ ⵉⵣⵏ ⵓⵔ ⵜⴻⴼⴽⵉⴷ ⵉⵙⵎ ⵏⵏⴽ ⵏⵖ ⵉⵎⴰⵢⵍ.', message: 'ⵉⵣⵏ ⵏⵏⴽ', send: 'ⴰⵣⵏ', anonymity: 'ⵓⵔ ⵏⵜⵜⵔ ⵜⴰⵎⴰⴳⵉⵜ ⵏⵏⴽ. ⵉⵣⵎⴰⵣ ⵉⵜⵉⵇⵏⵉⵢⵏ ⵣⵎⵔⵏ ⴰⴷ ⵙⵙⵎⵔⵙⵏ ⵉⵙⴰⵍⵏ ⴰⵎ IP ⴰⴼⴰⴷ ⴰⴷ ⵙⵙⵏⴽⴷⵏ ⴰⵙⵙⵎⵔⵙ ⵓⵔ ⵉⵍⴰⵏ.', unavailable: 'ⵜⵜⵓⵙⵎⵓⵜⵜⴳⵏ ⵉⵙⴰⵍⵏ، ⵓⵔ ⵜⴰ ⵜⵜⵓⵔⵣⴰⵎⵏ.', required: 'ⵙⵎⵎⴷ ⴰⵙⵙⵏⵜⵎ ⴷⴰⵜ ⵓⵣⴰⵏ.', error: 'ⵓⵔ ⵉⵙⵎⴷ ⵓⵣⴰⵏ. ⵔⵎⵙ ⴷⴰⵖ.', success: { petition: 'ⵉⵜⵜⵓⵣⵎⵎⴻⵎ ⵓⵣⵎⵎⴻⵎ ⵏⵏⴽ. ⵜⴰⵏⵎⵎⵉⵔⵜ.', newsletter: 'ⵜⴰⵏⵎⵎⵉⵔⵜ ⴼ ⵓⵍⴽⴰⵎ. ⵙⵙⵉⴳⴳⵍ ⵉⵎⴰⵢⵍ ⵏⵏⴽ ⴷ ⵓⴽⴰⵔⴰⵎ ⵏ spam ⵉ ⵉⵣⵏ ⵏ ⵓⵏⵙⵙⵓⴼ.', contact: 'ⵉⵍⴽⵎ ⵉⵣⵏ ⵏⵏⴽ.' } },
  nl: { ...english, tag: 'Doe mee', title: 'Steun de oproep tot waarheid.', intro: 'Onderteken de petitie, ontvang geverifieerde updates of stuur informatie privé.', petition: 'Onderteken de petitie', petitionBody: 'Steun de oproep tot volledige openheid, een behoorlijke rechtsgang en verantwoording. Het eerste doel is 10.000 handtekeningen.', signatures: 'handtekeningen', goal: 'Eerste doel', name: 'Volledige naam', email: 'E-mailadres', country: 'Land', sign: 'Mijn handtekening toevoegen', petitionPrivacy: 'Uw naam en e-mailadres worden niet openbaar weergegeven. Het e-mailadres wordt omgezet in een onomkeerbare vingerafdruk om dubbele handtekeningen te voorkomen.', newsletter: 'Ontvang updates over de zaak', newsletterBody: 'Abonneer u op belangrijke updates over de rechtszaak en de campagne. Na uw inschrijving sturen we een welkomstbericht.', consent: 'Ik ga akkoord met updates per e-mail en kan mij uitschrijven.', subscribe: 'Abonneren', contact: 'Stuur een privébericht', contactBody: 'Deel een correctie, bron of bericht zonder uw naam of e-mailadres op te geven.', message: 'Uw bericht', send: 'Bericht versturen', anonymity: 'Er wordt niet naar uw identiteit gevraagd. Technische dienstverleners kunnen gegevens zoals een IP-adres verwerken om misbruik te voorkomen.', unavailable: 'Inzendingen worden voorbereid en zijn nog niet geopend.', required: 'Voltooi de verificatie voordat u verstuurt.', error: 'De inzending kon niet worden voltooid. Probeer het opnieuw.', success: { petition: 'Uw handtekening is geregistreerd. Dank u.', newsletter: 'Dank voor uw inschrijving. Controleer uw inbox en spammap voor ons welkomstbericht.', contact: 'Uw bericht is ontvangen.' } },
...
const signerLabels: Record<Language, string> = {
  ...
  de: 'Neueste Unterzeichnende', tr: 'Son imzalayanlar', it: 'Ultimi firmatari', zgh: 'ⵉⵏⵣⵎⴰⵎⵏ ⵉⵎⴳⴳⵓⵔⴰ', nl: 'Laatste ondertekenaars', ja: '最新の署名者', zh: '最新签署者',
}
...
const petitionPrivacy: Record<Language, string> = {
  ...
  it: 'Solo le tue iniziali possono apparire pubblicamente. L’e-mail è facoltativa; se fornita, resta privata e viene trasformata in un’impronta irreversibile per evitare firme duplicate.',
  zgh: 'ⵖⴰⵙ ⵉⵙⴽⴽⵉⵍⵏ ⵉⵎⵣⵡⴰⵔⴰ ⵏ ⵉⵙⵎ ⵏⵏⴽ ⴰⴷ ⵣⵎⵔⵏ ⴰⴷ ⵜⵜⵓⵙⴽⴰⵏⵏ. ⵉⵎⴰⵢⵍ ⴷ ⴰⵙⵜⴰⵢ؛ ⵎⴽ ⵜ ⵜⴼⴽⵉⴷ، ⵔⴰⴷ ⵉⵇⵇⵉⵎ ⴷ ⵓⵙⵍⵉⴳ ⵉⵍⵉ ⵉⵜⵜⵓⵙⵏⴼⵍ ⵙ ⵜⵎⴰⵜⴰⵔⵜ ⵓⵔ ⵉⵜⵜⵓⵔⴰⵔⵏ ⴰⴼⴰⴷ ⴰⴷ ⵓⵔ ⵜⵜⵓⵙⵏⴼⵍⵏ ⵉⵣⵎⴰⵎⵏ.',
  nl: 'Alleen uw initialen kunnen openbaar verschijnen. E-mail is optioneel; als u die opgeeft, blijft deze privé en wordt deze omgezet in een onomkeerbare vingerafdruk om dubbele handtekeningen te voorkomen.',
...
const optionalLabels: Record<Language, string> = {
  en: 'optional', ar: 'اختياري', fr: 'facultatif', es: 'opcional', de: 'optional', tr: 'isteğe bağlı', it: 'facoltativo', zgh: 'ⴰⵙⵜⴰⵢ', nl: 'optioneel', ja: '任意', zh: '选填',
}
