...
const common = {
  ...
  disclaimer: 'Independent public-interest archive. Not an official family or court website. Corrections and primary documents are welcome.', updated: 'This website is updated as new information emerges from the courts and local media coverage.',
} satisfies Copy
...
const overrides: Record<Language, Partial<Copy>> = {
  ...
  zh: {
    ...
    sourcesTag: '查阅记录', sourcesTitle: '报道与来源', sourcesBody: '敏感说法应当可以追溯。以下来源构成第一版公开记录的起点。', videoBody: 'Brut Afrique记录公众为塔米·本纳尼寻求正义的报道。视频由Dailymotion提供播放，并受其隐私和Cookie政策约束。', watchVideo: '在Dailymotion观看', read: '打开来源', actionTitle: '让他的名字继续被看见。', actionBody: '认真阅读，负责任地分享。在每个问题得到答案之前，帮助保存经过核实的信息。', copyLink: '复制链接', copied: '已复制', principle: '真相 · 尊严 · 正义', disclaimer: '独立的公益档案，并非家属或法院的官方网站。欢迎提供更正和原始文件。', updated: '本网站将在法院或当地媒体出现新信息时及时更新。',
  },
}
