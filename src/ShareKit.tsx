...
async function createCampaignCard(format: ShareFormat, title: string, subtitle: string, siteUrl: string, hashtag: string, rtl: boolean) {
  ...
  context.font = `700 ${format === 'story' ? 82 : 64}px "Source Serif 4", serif`
  textY = drawWrappedText(context, title, textX, textY, canvas.width - padding * 2, format === 'story' ? 91 : 72)
  context.fillStyle = '#d5d1c8'
  context.font = `500 ${format === 'story' ? 35 : 29}px "Libre Franklin", sans-serif`
